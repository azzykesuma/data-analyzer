...
const SourceChart = ({analysisResult} : {analysisResult: CombinedAnalysisResult['orderAnalysis']}) => {
  const sourceLists = Object.entries(analysisResult.sourcePurchaseTickers).map(([key, value]) => ({ name: key, value: value }));
  return (
